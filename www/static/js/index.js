...
var _ObservableDataSet = __webpack_require__(329);

var _ObservableDataSet2 = _interopRequireDefault(_ObservableDataSet);
...
var Common = function () {
  ...
  _createClass(Common, [{
    key: 'init',
    value: function init() {
      var comments = new _ObservableDataSet2.default();
      var post = function post(text, title, time) {
        comments.nextItem = {
          text: text,
          title: title,
          time: time
      ...
      var edit = function edit(itemIndex, data) {
...
var _pubsubJs = __webpack_require__(334);

var _pubsubJs2 = _interopRequireDefault(_pubsubJs);

var _Comments = __webpack_require__(336);
...
var ObservableDataSet = function () {
  function ObservableDataSet() {
    var _this = this;

    _classCallCheck(this, ObservableDataSet);

    this.comments = new _Comments2.default();

    _pubsubJs2.default.subscribe('storeChanged', function () {
      _this.updateStore = _store.store.totalLength;
    });
  }

  _createClass(ObservableDataSet, [{
    key: 'nextItem',
    set: function set(params) {
      this.comments.nextItem = params;
      this.updateStore = _store.store.totalLength;
    }
  }, {
    key: 'updateStore',
    set: function set(totalLength) {
      var _this2 = this;

      var _loop = function _loop(i) {
        Object.defineProperty(_this2, i, {
          set: function set(params) {
            this.comments.editComment = _extends({}, params, {
              index: i
            });
          },
...
exports.default = ObservableDataSet;
var comments = exports.comments = new ObservableDataSet();
...
var PublicAPI = exports.PublicAPI = function () {
  ...
  _createClass(PublicAPI, null, [{
    key: 'Post',
    value: function Post(text, title, time) {
      _ObservableDataSet.comments.nextItem = {
        text: text,
        title: title,
        time: time
      };
    ...
    key: 'Edit',
    value: function Edit(index, data) {
      _ObservableDataSet.comments[index] = data;
    }
  }]);
...
var _gsap = __webpack_require__(331);
...
var Comments = function () {
  ...
  _createClass(Comments, [{
    key: 'createNextItem',
    value: function createNextItem(params) {
    ...
    value: function createComment(_ref) {
      ...
      //create text
      var textContainer = this.createChild({
        section: section,
        text: text,
        elementSelector: 'p',
      ...
      //create title
      var titleContainer = this.createChild({
        section: section,
        text: title,
        elementSelector: 'h1',
      ...
      //create time
      var timeContainer = this.createChild({
        section: section,
        text: time,
      ...
      var removeBtn = this.createChild({
        section: section,
        text: 'Remove',
        elementSelector: 'button',
    ...
    key: 'handleRemove',
    value: function handleRemove(btn, container) {
      btn.addEventListener('click', function () {
        container.remove();
        _store.store.totalLength--;
        _pubsubJs2.default.publish('storeChanged');
      });
    }
    ...
    value: function handleEdit(_ref2) {
      var editBtn = _ref2.editBtn,
          titleContainer = _ref2.titleContainer,
          textContainer = _ref2.textContainer;

      editBtn.addEventListener('click', function () {
        editBtn.classList.toggle('is-active');

        var active = editBtn.classList.contains('is-active');
    ...
    key: 'createChild',
    value: function createChild(_ref3) {
      var section = _ref3.section,
          text = _ref3.text,
          elementSelector = _ref3.elementSelector,
          selectorClass = _ref3.selectorClass,
          elementType = _ref3.elementType;

      var element = document.createElement(elementSelector || 'div');
    ...
    key: 'initAnim',
    value: function initAnim(elements) {
      var title = elements.titleContainer,
          text = elements.textContainer,
          time = elements.timeContainer,
      ...
      .fromTo([title, time], 0.5, {
        ...
        onStart: function onStart() {
          this.target.forEach(function (item) {
            return item.classList.add('transition-off');
          });
        },
        onComplete: function onComplete() {
          this.target.forEach(function (item) {
            return item.classList.remove('transition-off');
          });
        }
      })
      //text
    ...
    key: 'nextItem',
    set: function set(params) {
      var elements = this.addComment(params);
    ...
    set: function set(_ref4) {
      ...
      var messageContainer = this.container.children[index];
